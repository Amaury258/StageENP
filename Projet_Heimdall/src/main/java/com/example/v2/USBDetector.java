...
public class USBDetector {
     ...
     * @return
     */
    public static synchronized File makeTAGAntivirus(File root, Label label) {
        ArrayList<String> lines = new ArrayList<>();
        File tagnormal = null;
        try {
            tagnormal = File.createTempFile("tagnormal","",new File(System.getProperty("user.dir")+"\\tmp"));
    ...
    public static String eject(File drive) throws IOException {
        ...
        String batchFilePath = System.getProperty("user.dir") + "\\src\\main\\java\\com\\example\\v2\\ejecter.cmd";
