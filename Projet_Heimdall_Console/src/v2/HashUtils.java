...
public class HashUtils {
    ...
    public static File encrypt(File inputFile, String outputPath, String key) throws Exception {
        byte[] keyByte = key.getBytes();
        byte[] truncKey = Arrays.copyOfRange(keyByte,0,16);

        // Création de l'objet Cipher pour le chiffrement
        Cipher cipher = Cipher.getInstance("AES");
        cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(truncKey, "AES"));
